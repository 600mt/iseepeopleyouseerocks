...
export const FrameTwoPages = () => {
  const datasetImages = [Image_1, Image_2, Image_3, Image_4, Image_5, Image_6, Image_7, Image_8, Image_9, Image_10, Image_11, Image_12, Image_13, Image_14, Image_15, Image_16]
  return (
    <div id='framTwoPages'>
        <Navbar />
