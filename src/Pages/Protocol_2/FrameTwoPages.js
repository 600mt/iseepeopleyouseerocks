      ...
      >
        ...
        > 
          ...
          <div className="col-8 col-md-6 text-center">
              <h2 id='fontTitleHomepage' style={{paddingLeft: '3%',  marginTop: '1.2%'}}>Algorithms are forgetful</h2>
          </div>
          <div className="col-2 col-md-3">
      ...
      <div style={{position: 'absolute', height: '100%', width: '100%'}}>
        ...
        >
          ...
          > 
            ...
            <div className="col-8 col-md-6 text-center">
                <h2 id='fontTitleHomepage' style={{paddingLeft: '3%',  marginTop: '1.2%', color: '#0a84ff'}}>Algorithms are forgetful</h2>
            </div>
            <div className="col-2 col-md-3">
              <img  id='outAboutPage' onClick={() => setShow(!show)} src={close_logo} alt="info" />
            </div>
          </div>
          <div className='row'>
            <div
